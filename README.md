...
|---|---|---|
| **Дипломат** / **Воин** | **Diplomaticus vocis** / **Meliorator** | Дипломат и мелиоратор — одна роль. Воин — это мелиоратор. Занимается сексом голосом. Тело не требуется: акт — речь, голос, дыхание, тон. Переговоры и близость идут голосом. Через дипломата закрывают баги в социуме и государственных структурах. Не атака: улучшает (мелиорация). |
| **Арбитр** | **Arbiter praesens** | Арбитр — это устранение багов. Снимает сбои в социуме и государственных структурах. Действует **через дипломата**. Является воинским присутствием своим существованием. Не атака и не штаб: достаточно, что он есть. Пока арбитр существует — присутствие воинское. Защита своих прав — **через арбитра, просто отстояв**, **сделав исследование и отправив его в нужное место**. Принцип арбитра — **NaVi** (*Natus Vincere*). |
...
Баг — повторяемый сбой: тупик процедуры, лишний шаг, отказ без основания, молчание органа, поломка нормы в социуме. Пока баг не прошёл через дипломата, арбитр его не закрыл.
