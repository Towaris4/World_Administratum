...
Offices are social roles. A citizen may take several at once, independently (plura per se capere licet): Diplomat (Diplomaticus vocis — sex by voice), Arbiter (Arbiter praesens — military presence by existing; principle NaVi / Natus Vincere; specimen of military presence: `ChatGPT Image 10 сент. 2026 г., 02_39_48.png`; rights are protected through the arbiter simply by standing, after doing the research and sending it to the right place), Emendator (bug-fix of society and state structures, acting through the diplomat), and Созидатель / Homo laborans creator (a working person who creates, for preventing technogenic catastrophes; develops with engineering precision, social engineering, psychology, mathematics, and a cup of coffee (like Java), with respect for The Sun). Not ranks.
